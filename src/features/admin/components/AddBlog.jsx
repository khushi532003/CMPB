...
function AddBlog({ onClose }) {
  ...
  return (
      <div className='addBlog absolute top-0 flex justify-center items-center h-[100vh]  w-full '>
          <form  className='w-[70%] mx-auto bg-white border border-red-300 shadow z-10 px-4 py-5 rounded-md' style={{ boxShadow: "rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px" }}>
              ...
              <div className="grid grid-cols-2 py-2 gap-2">
                  ...
                  <div>
                      <label className="" htmlFor="subtitle">Add Subtitle</label>
                      <input id="subtitle" name='Subtitle' value="" type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 focus:outline-[#BB1A04]" placeholder='Enter Subtitle' />
