                        ...
                        <tbody>
                            {props?.data && props?.data?.map((item, i) => (
                                <tr key={i}>
                                    ...
                                    {props?.identifier === "programme" && <> <td className="px-5  py-2 border-b border-gray-200 bg-white text-lg">
                                        <p className="text-gray-900  text-sm whitespace-no-wrap">
                                            {item?.availableDates}
                                        </p>
                                    </td>
                                        ...
                                        <td className="px-5  py-2 border-b border-gray-200 bg-white text-lg flex gap-2">
                                            <span
