                ...
                <div onClick={(e) => { e.stopPropagation() }} className={`2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0`}>
                    <div className="flex items-center justify-between">
                        ...
                        <button role="button" aria-label="close modal" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 rounded-md cursor-pointer" >
                            <RxCross2 className='h-6 w-6 ' onClick={setNotificationOpen} />
                        </button>
                    </div>
                    ...
                    <h2 className="focus:outline-none text-sm leading-normal pt-8 border-b pb-2 border-gray-300 text-gray-600">YESTERDAY</h2>

                    <div className="w-full p-3 mt-4 bg-white rounded flex">
                        <div aria-label="loading icon" role="img" className="focus:outline-none w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
