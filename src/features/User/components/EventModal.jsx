...
function EventModal({ onClose }) {
  ...
  return (
   <div className="fixed w-[60%] top-[30%] left-[22%] z-50">
          <div className="bg-white rounded-lg p-6 text-center bg-cover bg-no-repeat bg-center" style={{ backgroundImage: "url(https://img.freepik.com/free-photo/small-white-blooming-flowers-pink-background_23-2147752460.jpg)"}} >
