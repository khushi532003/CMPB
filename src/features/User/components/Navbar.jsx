    ...
    return (
        <div>
            ...
            <div className={`responsive-bar md:hidden  left-0 w-full ${scrolling ? 'bg-gray-800 h-16 p-2 top-0 fixed' : 'bg-white h-20 p-4 relative'} flex justify-between items-center p-5 z-50`}>
                ...
                {token ?
                    <li className='list-none' onClick={() => setSidebarToggle(true)}><Link className="bg-[#BB1A04]  rounded-sm text-white transition duration-500 px-4 py-2">Account</Link></li>
                    : <li className='list-none'><Link to="/login" className="bg-[#BB1A04]  rounded-sm text-white transition duration-500 px-4 py-2">Login</Link></li>
                    }</div>
                ...
                <ul className={`md:hidden absolute top-[4rem] z-50 left-0 w-full bg-gray-800 ${menuOpen ? 'block' : 'hidden'}`}>
                    ...
                    <li><Link to="/happyStories" className="block text-white hover:bg-[#BB1A04]  text-center p-4  rounded-sm ">Happy Stories</Link></li>
                    <li><Link to="/happyStories" className="block text-white hover:bg-[#BB1A04]  text-center p-4  rounded-sm ">Contact Us</Link></li>
            ...
            {sideBarToggle ? <div className="sidebar  bg-white w-64 sm:w-80 p-5  z-50 fixed right-0 top-0 h-[100vh]">
                ...
                <div className="menus  w-full pt-20">
                    <ul>
                        <li onClick={() => setSidebarToggle(false)} className='text-lg border-b border-[#BB1A04] ps-5 py-3'><Link to="">Manage Profile</Link></li>
                        <li onClick={() => setSidebarToggle(false)} className='text-lg border-b border-[#BB1A04] ps-5 py-3'><Link to="/members">Active Members</Link></li>
                        <li onClick={() => setSidebarToggle(false)} className='text-lg border-b border-[#BB1A04] ps-5 py-3'><Link to="/myInterests">My Interests</Link></li>
                        <li onClick={() => setSidebarToggle(false)} className='text-lg border-b border-[#BB1A04] ps-5 py-3'><Link to="/purchaseHistory">Your Packages</Link></li>
                        <li onClick={() => setSidebarToggle(false)} className='text-lg border-b border-[#BB1A04] ps-5 py-3'><Link to="/changePassword">Change Password</Link></li>
                        <li onClick={() => setSidebarToggle(false)} className='text-lg border-b border-[#BB1A04] ps-5 py-3'><Link to="/deleteAccount">Delete Account</Link></li>
                        <li onClick={() => Logout()} className='cursor-pointer text-lg border-b border-[#BB1A04] ps-5 py-3'>Log Out</li>
                    </ul>
                </div>
            </div> : ""}
