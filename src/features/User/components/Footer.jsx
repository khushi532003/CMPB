...
function Footer() {
  return (
    ...
    <div>
      <footer className="">
              <div className="flex items-end w-full bg-cover bg-left bg-no-repeat " style={{ backgroundImage: "url(https://img.freepik.com/premium-vector/white-crumpled-paper-textured-background-vector_53876-171750.jpg)"}}>

                  <footer className="w-full text-gray-700  body-font">
                      <div className="logo flex justify-center">
                          <img className='w-48' src="https://static1.squarespace.com/static/56538fa7e4b0eb26e633fae6/t/5e4b23d4b6e8306d010ab29f/1581982686307/PrimaryLogoTransparentBG.png?format=1500w" alt="logo"/>
                      </div>
                      <div
