  ...
  return (
    <div>
      ...
      <section className="about py-5">
        <div className="grid grid-cols-2 gap-3 pe-4">
      ...
      <section className="services py-5">
        ...
        <div className="service py-5 ">
          <div className='flex gap-7 w-full px-4'>
            <div className="functions flex gap-3 w-[70%] items-center">
            ...
            <div className="functionName w-[30%] flex flex-col justify-center text-center bg-cover bg-center h-[80vh]" style={{ backgroundImage: "url(https://static.vecteezy.com/system/resources/previews/024/554/091/non_2x/gold-geometric-floral-greenery-leaves-frames-free-png.png)" }}>
