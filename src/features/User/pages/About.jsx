        ...
        <div className="reasons py-5 w-[90%] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 ">
            <div className="reason mx-auto  rounded-full border-2 px-4 border-yellow-500 w-60 flex flex-col justify-center items-center h-60 text-center bg-[#bb1904ad] text-white">
              ...
              <div className="icon">
                <img className='w-20' src="./images/about_wcu/1.png" alt="about-us-icon-1" />
              </div>
              <p className="">We are a symbol of <strong>Vedic & Modern</strong> Culture</p>
            </div>
            <div className="reason mx-auto rounded-full border-2 px-4 border-yellow-500 w-60 flex flex-col justify-center items-center h-60  text-center bg-[#bb1904ad] text-white">
              <div className="icon">
                <img className='w-20' src="./images/about_wcu/2.png" alt="about-us-icon-2" />
              </div>
              <p className="">We Know you, <strong>better than you</strong> </p>
            </div>
            <div className="reason mx-auto rounded-full border-2 px-4  border-yellow-500 w-60 flex flex-col justify-center items-center h-60  text-center bg-[#bb1904ad] text-white">
              <div className="icon">
                <img className='w-20' src="./images/about_wcu/3.png" alt="about-us-icon-3" />
              </div>
              <p className="">Having valid experience of <strong>16-17</strong>  years</p>
            </div>
            <div className="reason mx-auto rounded-full border-2 px-4 border-yellow-500 w-60 flex flex-col justify-center items-center h-60 text-center bg-[#bb1904ad] text-white">
              <div className="icon">
                <img className='w-20' src="./images/about_wcu/4.png" alt="about-us-icon-4" />
              </div>
      ...
      <section className="services py-5">
        ...
        <div className="service py-5">
          <div className='block sm:flex gap-7 w-full px-4'>
            <div className="functions block sm:flex gap-3 w-full sm:w-[70%] items-center">
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/haldi.webp" alt="Haldi" />
              </div>
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/mehendi.webp" alt="Mehendi" />
              </div>
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/sangeet.webp" alt="Sangeet" />
              </div>
            </div>
          ...
          <div className='block sm:flex gap-7 w-full px-4'>
            ...
            <div className="functions block sm:flex gap-3 w-full sm:w-[70%] items-center">
              <div className="function  py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/cocktail.webp" alt="Cocktail" />
              </div>
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/wedding.webp" alt="Wedding" />
              </div>
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/reception.webp" alt="Reception" />
              </div>
            </div>
          </div>
          <div className='block sm:flex gap-7 w-full px-4'>
            <div className="functions block sm:flex gap-3 w-full sm:w-[70%] items-center">
              <div className="function  py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/clothes.webp" alt="Clothes" />
              </div>
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/photographers.webp" alt="Photographers" />
              </div>
              <div className="function py-2">
                <img className='rounded-t-full h-96 object-cover w-full' src="./images/services/caterers.webp" alt="Caterers" />
              </div>
            </div>
            <div className="functionName w-full sm:w-[30%] flex flex-col justify-center text-center bg-cover bg-center h-[65vh] sm:h-[80vh]" style={{ backgroundImage: "url(https://static.vecteezy.com/system/resources/previews/024/554/091/non_2x/gold-geometric-floral-greenery-leaves-frames-free-png.png)" }}>
