                    ...
                    <div className="layout ">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="w-full mt-6">
                                <button type='submit' className="px-6 py-2 w-full leading-5 text-white transition-colors duration-200 transform bg-[#BB1A04] rounded-md hover:bg-[#bb0404] focus:outline-none focus:bg-gray-600">Change Password</button>
                            </div>
                        </form>
                    </div>
                </div>
